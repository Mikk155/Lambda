...
LOCALISATION["english"] = {
    ...
    ["GM_LIMITED_FLASHLIGHT"] = "Flashlight",
    ["GM_LIMITED_FLASHLIGHT_DESC"] = "Flashlight consumes AUX Power",
    ...
    ["GM_SURVIVALMODE"] = "Survival Mode",
    ["GM_SURVIVALMODE_DESC"] = "Players have to wait for checkpoints in order to respawn",
    ["GM_RESTARTTIME"] = "Restart time",
    ["GM_RESTARTTIME_DESC"] = "Set time between round ending and starting",
    ["GM_PLAYER_MAX_HEALTH"] = "Player health",
    ["GM_PLAYER_MAX_HEALTH_DESC"] = "Player max health",
    ["GM_PLAYER_MAX_ARMOR"] = "Player armor",
    ["GM_PLAYER_MAX_ARMOR_DESC"] = "Player max armor",
